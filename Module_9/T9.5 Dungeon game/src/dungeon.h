...
/**
 * \brief Pair of coordinates in the 2-dimensional map
 */
typedef struct {
	int x, y;
} Point;
...
/**
 * \brief Room information. Used only in map creation
 */ 
typedef struct {
	int x1, x2, y1, y2;
	unsigned int w, h;
...
/**
 * \brief 2-dimensional dynamically allocated array for the game map
...
/**
 * \brief Global data for the game
 */ 
struct game_st {
	Map map;
